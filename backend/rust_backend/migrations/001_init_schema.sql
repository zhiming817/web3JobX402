...
CREATE TABLE IF NOT EXISTS users (
    ...
    wallet_address VARCHAR(44) UNIQUE NOT NULL COMMENT 'Solana 钱包地址',
...
CREATE TABLE IF NOT EXISTS resumes (
    ...
    owner_wallet VARCHAR(44) NOT NULL COMMENT '所有者钱包地址',
    ipfs_cid VARCHAR(100) NOT NULL COMMENT 'IPFS/Irys CID',
...
CREATE TABLE IF NOT EXISTS unlock_records (
    ...
    buyer_wallet VARCHAR(44) NOT NULL COMMENT '购买者钱包地址',
    seller_wallet VARCHAR(44) NOT NULL COMMENT '卖家钱包地址',
    amount BIGINT NOT NULL COMMENT '支付金额(lamports)',
    transaction_signature VARCHAR(88) UNIQUE NOT NULL COMMENT 'Solana 交易签名',
